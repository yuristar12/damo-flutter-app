...
class SupplierCategoryPage extends StatefulWidget {
  @override
  _SupplierCategoryPageState createState() => _SupplierCategoryPageState();
}

class _SupplierCategoryPageState extends State<SupplierCategoryPage>
    with SingleTickerProviderStateMixin {
  late TabDiscoverViewModel _tabDiscoverViewModel;
  ...
  void initState() {
    super.initState();
    supplierId = XUtils.textOf(Get.parameters[AppParameters.ID]);
    _tabDiscoverViewModel = TabDiscoverViewModel(supplierId: supplierId);
  ...
  void toSearch() {
    NavigatorUtil.goSearchGoods(context,
        keyword: _keyController.text, supplierId: supplierId);
  }
  ...
  _categoryClick(CategoryEntity categoryEntity, [bool showChild = false]) {
    ...
    if (showChild) {
      ...
      NavigatorUtil.goSearchGoods(Get.context,
          categoryId: XUtils.textOf(categoryEntity.id),
          categoryName: XUtils.textOf(categoryEntity.name),
