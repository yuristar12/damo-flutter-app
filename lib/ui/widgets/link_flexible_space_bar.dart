...
typedef FlexibleChildBuilder = Widget Function(
    BuildContext buildContext, bool expanded);
...
class LinkFlexibleSpaceBar extends StatefulWidget {
  ...
  final FlexibleChildBuilder? childBuilder;
        ...
        Column(
            children: <Widget>[
              ...
              widget.childBuilder != null
                  ? widget.childBuilder!(context, opacity > 0)
                  : SizedBox.shrink(),
            ],
          ),
      );
