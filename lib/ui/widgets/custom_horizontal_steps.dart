...
class CustomHorizontalSteps extends StatefulWidget {
  /// The steps of the stepper whose titles, subtitles, icons always get shown.
  ///
  /// 步骤条中元素的列表
  final List<CustomBrunoStep> steps;

  /// 控制类
  final CustomStepsController? controller;
  ...
  @override
  State<StatefulWidget> createState() => CustomHorizontalStepsState();
}

class CustomHorizontalStepsState extends State<CustomHorizontalSteps> {
  Color get _primary {
  ...
  @override
  void didUpdateWidget(covariant CustomHorizontalSteps oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    final List<CustomBrunoStep> steps = widget.steps;
  ...
  Widget _applyStepItem(CustomBrunoStep step, int index) {
    return Expanded(
      child: Column(
  ...
  Widget _applyStepAndLine(CustomBrunoStep step, int index) {
    return Row(
      ...
      children: [
        ...
        GestureDetector(
            ...
            child: _applyStepIcon(step, index)),
  ...
  Widget _applyStepIcon(CustomBrunoStep step, int index) {
    Widget icon;
  ...
  Widget _applyStepContent(CustomBrunoStep step, int index) {
  ...
  Widget _getCompletedIcon(CustomBrunoStep step) {
  ...
  Widget _getDoingIcon(CustomBrunoStep step) {
...
class CustomStepsController with ChangeNotifier {
  /// 指示当前进行态的步骤
  int currentIndex;
  ...
  CustomStepsController({this.currentIndex = 0, this.isCompleted = false});
