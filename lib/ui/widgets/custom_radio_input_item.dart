...
class CustomRadioInputFormItem extends StatefulWidget {
  ...
  @override
  CustomRadioInputFormItemState createState() {
    return CustomRadioInputFormItemState();
  }
}

class CustomRadioInputFormItemState extends State<CustomRadioInputFormItem> {
  ...
  double _getTitleMaxWidth(BuildContext context, BoxConstraints constraints) {
    ...
    double maxWidth = min(ratioWidth, _calculateTextWidth(context)) + 8;
    return maxWidth;
  }
